...
////horas hoja trabajo
export const FETCH_HORAS_TRABAJOS_DIARIOS = 'fetch_horas_trabajos_diarios';
export const CLEAR_HORAS_TRABAJOS_DIARIOS = 'clear_horas_trabajos_diarios';
export const FETCH_HORA_TRABAJO_DIARIO = 'fetch_hora_trabajo_diario';
export const UPDATE_HORA_TRABAJO_DIARIO = 'update_hora_trabajo_diario';
export const CREATE_HORA_TRABAJO_DIARIO = 'create_hora_trabajo_diario';
export const DELETE_HORA_TRABAJO_DIARIO = 'delete_hora_trabajo_diario';

////tasas hora hombre
export const FETCH_TASAS_HORAS_HOMBRES = 'fetch_tasas_horas_hombres';
export const FETCH_TASA_HORA_HOMBRE = 'fetch_tasa_hora_hombre';
export const UPDATE_TASA_HORA_HOMBRE = 'update_tasa_hora_hombre';
export const CREATE_TASA_HORA_HOMBRE = 'create_tasa_hora_hombre';
export const DELETE_TASA_HORA_HOMBRE = 'delete_tasa_hora_hombre';
