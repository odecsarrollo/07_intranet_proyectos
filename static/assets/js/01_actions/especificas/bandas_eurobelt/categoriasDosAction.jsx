import {BANDA_EUROBELT_CATEGORIA_TYPES as TYPES} from '../../00_types';
import {
    fetchListGet,
    updateObject,
    fetchObject,
...
export const deleteBandaEurobeltCategoria = (id, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const fetchBandaEurobeltCategoria = (id, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
...
export const clearBandaEurobeltCategorias = () => {
    return (dispatch) => {
        dispatch({type: TYPES.clear});

    }
};
export const updateBandaEurobeltCategoria = (id, values, options_action = {}) => {
    return (dispatch) => {
        const dispatches = (response) => {
            dispatch({type: TYPES.update, payload: response})
        };
