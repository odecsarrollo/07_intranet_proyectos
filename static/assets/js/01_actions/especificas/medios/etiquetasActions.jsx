import {ETIQUETA_MEDIOS_TYPES as TYPES } from '../../00_types';
import {
     fetchListGet,
    updateObject,
    fetchObject,
...
export const deleteEtiquetaMedios = (id, options_action = {}) => {
    return (dispatch) => {
...
export const fetchEtiquetasMedios = (options_action = {}) => {
    return (dispatch) => {
...
export const fetchEtiquetaMedios = (id, options_action = {}) => {
    return (dispatch) => {
...
export const clearEtiquetasMedios = () => {
    return (dispatch) => {
        dispatch({type: TYPES.clear});
       
    }
};
export const updateEtiquetaMedios = (id, values, options_action = {}) => {
    return (dispatch) => {
