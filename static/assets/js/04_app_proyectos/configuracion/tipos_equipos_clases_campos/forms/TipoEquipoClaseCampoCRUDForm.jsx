...
let TipoEquipoClaseCampoCRUDForm = memo(props => {
    const {
        pristine,
        submitting,
        reset,
...
TipoEquipoClaseCampoCRUDForm = reduxForm({
    form: "tipoEquipoCampoCRUDForm",
    validate: validate,
    enableReinitialize: true
})(TipoEquipoClaseCampoCRUDForm);

export default TipoEquipoClaseCampoCRUDForm;