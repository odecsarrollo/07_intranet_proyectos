...
export const CONDICIONES_INICIOS_PROYECTOS = {
    ...
    change: 'change_condicioninicioproyecto',
    list: 'list_condicioninicioproyecto',
    detail: 'view_condicioninicioproyecto',
};
...
export const PROFORMAS_ANTICIPOS_CONFIGURACION = {
    change: 'change_proformaconfiguracion',
    detail: 'view_proformaconfiguracion',
};
...
export const ADHESIVO_MEDIOS_CATALOGOS = {
    add: 'add_adhesivo',
    delete: 'delete_adhesivo',
    change: 'change_adhesivo',
    list: 'list_adhesivo',
    detail: 'view_adhesivo',
};
...
export const COTIZACIONES = {
    ...
    list_cotizaciones_notificaciones_consecutivo_proyectos: 'list_cotizaciones_notificaciones_consecutivo_proyectos',
    list_cotizaciones_abrir_carpeta: 'list_cotizaciones_abrir_carpeta',
    rel_cotizacion_adicional_a_literal: 'rel_cotizacion_adicional_a_literal',
    rel_cotizacion_proyecto: 'rel_cotizacion_proyecto',
