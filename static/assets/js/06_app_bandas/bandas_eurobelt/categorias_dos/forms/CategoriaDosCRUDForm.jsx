...
let Form = memo(props => {
    ...
    const adicionarCategoriaProducto = () => {
        return dispatch(actions.adicionarQuitarCategoriaProductoBandaEurobeltCategoria(initialValues.id, categoria_seleccionado_id))
    };

    const quitarCategoriaProducto = (categoria_producto_id) => {
        return dispatch(actions.adicionarQuitarCategoriaProductoBandaEurobeltCategoria(initialValues.id, categoria_producto_id))
    };
