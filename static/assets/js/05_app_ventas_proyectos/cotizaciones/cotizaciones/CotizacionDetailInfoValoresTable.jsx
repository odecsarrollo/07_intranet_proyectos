    ...
    return (
        <table className='table table-striped'>
            ...
            <tr style={table.tr}>
                ...
                <td style={table.td_right}>{pesosColombianos(cotizacion.valor_orden_compra)}</td>
                <td style={table.td_right}>{pesosColombianos(cotizacion.costo_presupuestado)}</td>
            </tr>
            {(cotizacion.valor_orden_compra_adicionales > 0 ||
                cotizacion.costo_presupuestado_adicionale > 0) &&
            <Fragment>
                <tr style={table.tr}>
                    <td style={table.td}>Cotizaciones Adicionales</td>
                    <td style={table.td_right}>{pesosColombianos(cotizacion.valor_orden_compra_adicionales)}</td>
            ...
            <tr style={table.tr}>
                ...
                <td style={table.td_right}>{pesosColombianos(cotizacion.valor_orden_compra + cotizacion.valor_orden_compra_adicionales)}</td>
